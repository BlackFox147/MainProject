...
namespace MainProject.Controllers
{
    public class HomeController : Controller
    {
        public ActionResult Index()
        {
            ...
            //using (UserContextNew db = new UserContextNew())
            //{
            //    var elements = from s in db.Elements select s;
            //    elements = elements.Where(c => c.Data.Contains("Hello"));
            //    var end = elements.Distinct().ToList();
               
            //    ///(p => p.Elements.Where(e => e.Data.Contains("Hello"))
